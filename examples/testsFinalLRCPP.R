...
# Benchmark the function with microbenchmark
benchmark_result <- microbenchmark(
  LRogFunction_50_iter = LRMultiClassO(X, y, Xt, yt, numIter = 50, eta = 0.1, lambda = 1, beta_init = beta_init),
  LRogFunction_100_iter = LRMultiClassO(X, y, Xt, yt, numIter = 100, eta = 0.05, lambda = 0.5, beta_init = beta_init),
  LR_wrapper_50_iter = LRMultiClass(X, y, numIter = 50, eta = 0.1, lambda = 1, beta_init = beta_init),
  LR_wrapper_100_iter = LRMultiClass(X, y, numIter = 100, eta = 0.05, lambda = 0.5, beta_init = beta_init),
  times = 10  # Number of repetitions for each configuration
)
