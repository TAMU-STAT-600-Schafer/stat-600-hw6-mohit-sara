...
# Define small example data directly
X <- matrix(c(1, 1, 1, 1, 2, 3, 4, 5), ncol = 2)
y <- c(0, 1, 0, 1)
beta_init <- matrix(0, nrow = 2, ncol = 2)

# Call LRMultiClass_c directly
result <- LRMultiClass_c(X, y, beta_init, numIter = 10, eta = 0.1, lambda = 1)
